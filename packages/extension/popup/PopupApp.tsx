...
// 
// Flow:
// 1. Component initialization (const declarations)
// 2. App initialization trigger (useEffect)
// 3. Router creation and rendering
...
export const PopupApp: React.FC = () => {
  ...
  // Step 1: Initialize app on mount
  useEffect(() => {
    initializeApp();
  }, [initializeApp]);

  // Create router using the initialization state
  ...
  // Handler for extension-specific functionality
