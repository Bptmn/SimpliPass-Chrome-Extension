try {
  (() => {
    ...
    var yt = __STORYBOOK_COMPONENTS__,
      {
        A: ft,
        ActionBar: Rt,
        AddonPanel: Pt,
    ...
    var W = { type: 'item', value: '' },
      ...
      Y = ['reset'],
      z = (r) => r.filter((t) => !Y.includes(t.type)).map((t) => t.value),
      S = 'addon-toolbars',
      $ = async (r, t, e) => {
        (e &&
          e.next &&
      ...
      Z = ({ active: r, disabled: t, title: e, icon: o, description: a, onClick: c }) =>
        n.createElement(
          M,
          { active: r, title: a, disabled: t, onClick: t ? () => {} : c },
          o && n.createElement(x, { icon: o, __suppressDeprecationWarning: !0 }),
          e ? `\xA0${e}` : null,
        ),
      X = ({
        right: r,
        ...
        let l =
          ...
          u = { id: e ?? '_reset', active: i === e, right: r, title: t, disabled: b, onClick: c };
      ...
      Q = q(
        ({
          ...
          name: t,
          description: e,
          toolbar: { icon: o, items: a, title: c, preventDynamicIcon: b, dynamicTitle: i },
        }) => {
          let [l, u, C] = g(),
            [O, y] = B(!1),
            s = l[r],
            ...
            p = o,
            d = c;
          (b || (p = j({ currentValue: s, items: a }) || p),
            i && (d = J({ currentValue: s, items: a }) || d),
            !d && !p && console.warn(`Toolbar '${t}' has no title or icon`));
          let V = A(
            (R) => {
              u({ [r]: R });
            },
          ...
          return n.createElement(
            G,
            {
              ...
              tooltip: ({ onHide: R }) => {
                ...
                return n.createElement(F, { links: U });
              },
