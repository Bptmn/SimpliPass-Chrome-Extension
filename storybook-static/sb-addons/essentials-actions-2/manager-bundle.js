try {
  (() => {
      ...
      if (e && t && (r = e.constructor) === t.constructor) {
        ...
        if (r === Map) {
          ...
          for (n of e)
            if (
              ((a = n[0]),
              (a && typeof a == 'object' && ((a = Fe(t, a)), !a)) || !I(n[1], t.get(a)))
            )
              return !1;
          return !0;
        }
        ...
        if (!r || typeof e == 'object') {
          n = 0;
          for (r in e)
            if ((Be.call(e, r) && ++n && !Be.call(t, r)) || !(r in t) || !I(e[r], t[r])) return !1;
    ...
    function Lt(e, t) {
      if (t === 'transparent') return t;
      var r = A(t);
      return C(_({}, r, { lightness: P(0, 1, r.lightness - parseFloat(e)) }));
    }
    var bl = v(Lt);
    function Pt(e, t) {
      if (t === 'transparent') return t;
      var r = A(t);
      return C(_({}, r, { saturation: P(0, 1, r.saturation - parseFloat(e)) }));
    }
    var hl = v(Pt);
    function Dt(e, t) {
      if (t === 'transparent') return t;
    ...
    function Ft(e, t) {
      ...
      var r = L(t),
        ...
        a = _({}, r, { alpha: P(0, 1, (n * 100 + parseFloat(e) * 100) / 100) });
      return $(a);
    }
    var Ht = v(Ft),
      qe = Ht;
    ...
    function Vt(e, t) {
      ...
      var r = L(t),
        n = typeof r.alpha == 'number' ? r.alpha : 1,
        a = _({}, r, { alpha: P(0, 1, +(n * 100 - parseFloat(e) * 100).toFixed(2) / 100) });
      return $(a);
    }
    var Rl = v(Vt);
    var $t = 'actions',
    ...
    var Er = ({ rows: e, columns: t, rowsData: r }) => {
      ...
      lt = Se(({ children: e, className: t }, r) =>
        o.createElement(Ie, { ref: r, horizontal: !0, vertical: !0, className: t }, e),
      );
    lt.displayName = 'UnstyledWrapped';
    var Br = B(lt)({ margin: 0, padding: '10px 5px 20px' }),
      Fr = He(({ theme: e, ...t }) =>
        o.createElement(Lr, { theme: e.addonActionsTheme || 'chromeLight', table: !1, ...t }),
      ),
