/**
 * CodeConfirmationPage.tsx
 * 
 * Generic code confirmation page that can be used for:
 * - Email confirmation
 * - MFA (Multi-Factor Authentication) confirmation
 * - Any other code-based verification
 * 
 * Displays a form for users to enter verification codes
 * and handles the confirmation process.
 */
