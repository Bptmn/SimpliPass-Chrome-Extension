...
export async function getAllCredentialsInFirestore(userId: string): Promise<CredentialEncrypted[]> {
...
export async function updateCredentialInFirestore(
  ...
  console.log(
    '[Firestore] Updating credential with userId:',
    userId,
    'credentialId:',
    credentialId,
  );
...
/* Delete a credential */
export async function deleteCredentialInFirestore(
  userId: string,
  credentialId: string,
): Promise<void> {
  console.log(
    '[Firestore] Deleting credential with userId:',
    userId,
    'credentialId:',
    credentialId,
  );
