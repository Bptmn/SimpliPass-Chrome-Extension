 ...
 */
import { getCurrentUser as getCurrentUserFromFirebase, signInWithFirebaseToken, signOutFromFirebase } from 'services/firebase';
import { signOutCognito, loginWithCognito, confirmMfaWithCognito } from 'services/cognito';
import { openDB, putItem, getItem, deleteItem, clearStore } from 'services/indexdb';
...
export async function confirmMfa({ code, password, mfaUser }: { code: string; password: string; mfaUser: any; }) {
