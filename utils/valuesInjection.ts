  ...
  function injectCredential(username: string, password: string): boolean {
    ...
    for (const form of forms) {
      ...
      const userInput =
        ...
        form.querySelector('input[autocomplete*="user" i], input[autocomplete*="email" i], input[autocomplete*="login" i]') ||
        form.querySelector('input[name*="user" i], input[name*="email" i], input[name*="login" i]') ||
        form.querySelector('input[id*="user" i], input[id*="email" i], input[id*="login" i]') ||
        form.querySelector('input[aria-label*="user" i], input[aria-label*="email" i], input[aria-label*="login" i]') ||
        form.querySelector('input[placeholder*="user" i], input[placeholder*="email" i], input[placeholder*="login" i]') ||
